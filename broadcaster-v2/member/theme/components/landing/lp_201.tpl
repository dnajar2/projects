<div id="top">
    <div id="top_box">
        <div id="top_box_txt">
            <img src="{$_SITE_IMAGES_DEFAULT_}/global/landing/100/{$join_type}_top_text.png" />
        </div>
        <div id="video_top">
            <div id="video_box">
...
<div id="lp_100" style="{if $join_type == "ccjoin"}height:880px;{else}height:680px;{/if}background-image:url({$_SITE_IMAGES_DEFAULT_}/global/landing/100/{$join_type}_body_bg.jpg);">
	...
	{if !$smarty.session.ccjoin.locked_out}
    	<div id="jff">
	        <div id="jff_arrow"><img src="{$_SITE_IMAGES_DEFAULT_}/global/landing/100/jff_arrow.png" /></div>
	    </div>
    {/if}
