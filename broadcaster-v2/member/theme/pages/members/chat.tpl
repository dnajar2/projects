...
<body>
	...
	<div id="container">
		<div id="container_bg">
			...
			var modelsplugin = '{$modelsplugin}';
			var mp_show_id = '{$mp_show_id}';
			...
			var loadSIO = true;
			var loadMPD = false;
			var loadEmbedChat = false;
			var canResizeLoader = true;
			var isWCC3 = true;
			</script>

            <script language="JavaScript" type="text/javascript" src="{$smarty.const.CDN_SCHEMA}/flashApps/js/app/view/initializer.js{$CacheBuster->getFileRevision()}"></script>
            {literal}
        ...
        <div id="chat_swf_waiting" style="width:100%;left:0px; top:48%; position:absolute;opacity:0;">
            ...
            <img id="chat_swf_waiting_loader_img" src="{$smarty.const.CDN_SCHEMA}/images/wcc2/global/AjaxLoader.gif" border="0" />
            </div>
        </div>
    </div>
{literal}
